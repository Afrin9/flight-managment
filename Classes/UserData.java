...
public class UserData implements ActionListener{
    ...
    UserData() {
        ...
        jf.setTitle("Travel Agency");
        jf.setSize(700, 600);
        jf.setLocationRelativeTo(null);
        jf.setResizable(false);
        jf.setVisible(true);
        jf.setLayout(null);
        jf.setBackground(Color.decode("#F2F2F2"));
        ...
        label1.setBounds(200, 10, 300, 80);
        label1.setFont(f1);
        jf.add(label1);

        // JButtons
        btn1 = new JButton("Refresh");
        btn1.setBounds(54, 418, 100, 30);
        //btn1.setFont(f2);
